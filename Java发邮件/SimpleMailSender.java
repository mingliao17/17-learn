import org.mingliao.task.model.MailSenderInfo;
...
public class SimpleMailSender {
    ...
    public static void main(String[] args) {
        ...
        // 密送
        String[] toBCC = {"#######@gmail.com"};
        mailInfo.setToBlindCarbonCopyAddress(toBCC);
        // 附件
        mailInfo.setAttachFileNames(new String[]{"C:/Users/mingliao/Desktop/Java开发手册.pdf"});
        // 主题
        mailInfo.setSubject("change world");
        // 正文内容
        String body = "你好</br>以下附件为机密文件，请查收";
